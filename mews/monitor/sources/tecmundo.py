...
class TecMundo(BaseRSS):
    def __init__(self):
        self.uri = "https://www.tecmundo.com.br/minha-serie/tag/anime/"
    ...
    async def work(self):
        ...
        for entrie in entries[:10]:
            ...
            published_date = int(round(time.mktime(time.struct_time((published_date[2], published_date[1], published_date[0], 0, 0, 0, 0, 0, 0)))))
